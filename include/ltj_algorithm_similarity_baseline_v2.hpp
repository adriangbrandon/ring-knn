...
#ifndef RING_LTJ_ALGORITHM_SIMILARITY_BASELINE_V2_HPP
#define RING_LTJ_ALGORITHM_SIMILARITY_BASELINE_V2_HPP
...
namespace ring_ltj {
    ...
    class ltj_algorithm_similarity_baseline_v2 {
    ...
    private:
        ...
        type1_sim_patterns_set_type m_type0_set;
        ...
        void copy(const ltj_algorithm_similarity_baseline_v2 &o) {
    ...
    public:
        ...
        ltj_algorithm_similarity_baseline_v2() = default;

        ltj_algorithm_similarity_baseline_v2(const std::vector<triple_pattern>* triple_patterns,
        ...
        //! Copy constructor
        ltj_algorithm_similarity_baseline_v2(const ltj_algorithm_similarity_baseline_v2 &o) {
            copy(o);
        }

        //! Move constructor
        ltj_algorithm_similarity_baseline_v2(ltj_algorithm_similarity_baseline_v2 &&o) {
            *this = std::move(o);
        }

        //! Copy Operator=
        ltj_algorithm_similarity_baseline_v2 &operator=(const ltj_algorithm_similarity_baseline_v2 &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        //! Move Operator=
        ltj_algorithm_similarity_baseline_v2 &operator=(ltj_algorithm_similarity_baseline_v2 &&o) {
            if (this != &o) {
                ...
                m_type0_set = std::move(o.m_type0_set);
        ...
        void swap(ltj_algorithm_similarity_baseline_v2 &o) {
            ...
            std::swap(m_type0_set, o.m_type0_set);
        ...
        std::pair<size_type, int> next_similarity_triple_pattern(){
            size_type next;
            if(m_type0_set.empty() && m_type1_set.empty()){
                size_type weight = 0;
                ...
                size_type weight = 0;
                for(const auto &id : m_type0_set){
                    if(m_weight_sim_patterns[id] > weight){
                        weight = m_weight_sim_patterns[id];
                        next = id;
                    }
                }
                m_type0_set.erase(next);
                return {next, 0};
            }
        }
        ...
        void solve_pattern(size_type id, int t, std::vector<tuple_type> &pre){
        ...
        void knn_filter( std::vector<tuple_type> &pre){
            ...
            while(!(m_type0_set.empty() && m_type1_set.empty() && m_type2_set.empty())){
