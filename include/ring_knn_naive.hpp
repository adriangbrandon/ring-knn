...
namespace ring_ltj {
    ...
    private:
        ...
        void copy(const ring_knn_naive &o) {
            m_bwt_s = o.m_bwt_s;
            m_bwt_p = o.m_bwt_p;
            m_bwt_o = o.m_bwt_o;
            m_max_s = o.m_max_s;
    ...
    public:
        ...
        ring_knn_naive() = default;

        // Assumes the triples have been stored in a vector<spo_triple>
        ring_knn_naive(vector<spo_triple_type> &D, knn_graph_type &g, size_type max_k) {
            uint64_t i, pos_c;
        ...
        //! Copy constructor
        ring_knn_naive(const ring_knn_naive &o) {
            copy(o);
        }

        //! Move constructor
        ring_knn_naive(ring_knn_naive &&o) {
            *this = std::move(o);
        }

        //! Copy Operator=
        ring_knn_naive &operator=(const ring_knn_naive &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        //! Move Operator=
        ring_knn_naive &operator=(ring_knn_naive &&o) {
            if (this != &o) {
    ...
    uint64_t ring_knn_naive<bwt_so_t, bwt_sp_t>::min_P_in_S(bwt_interval &I, uint64_t s_value) {
        std::pair<uint64_t, uint64_t> q;
    ...
    uint64_t ring_knn_naive<bwt<>>::min_P_in_S(bwt_interval &I, uint64_t s_value) {
    ...
    template<> //No select in BWT
    uint64_t ring_knn_naive<bwt_rrr>::min_P_in_S(bwt_interval &I, uint64_t s_value) {
        uint64_t s_aux = I.left();
        std::pair<uint64_t, uint64_t> o_r = m_bwt_o.inverse_select(s_aux);
        uint64_t p = m_bwt_p[m_bwt_p.get_C(o_r.second) + o_r.first];
        I.set_stored_values(p, 0);
    ...
    template <class bwt_so_t, class bwt_sp_t> //Select in BWT
    uint64_t ring_knn_naive<bwt_so_t, bwt_sp_t>::next_P_in_S(bwt_interval &I, uint64_t s_value, uint64_t p_value) {
        if (p_value > m_max_p) return 0;
    ...
    template <> //NO Select in BWT
    uint64_t ring_knn_naive<bwt<>>::next_P_in_S(bwt_interval &I, uint64_t s_value, uint64_t p_value) {
        if (p_value > m_max_p) return 0;
    ...
    template <> //NO Select in BWT
    uint64_t ring_knn_naive<bwt_rrr>::next_P_in_S(bwt_interval &I, uint64_t s_value, uint64_t p_value) {
        if (p_value > m_max_p) return 0;
    ...
    template <class bwt_so_t, class bwt_sp_t> //Select in BWT
    uint64_t ring_knn_naive<bwt_so_t, bwt_sp_t>::min_S_in_O(bwt_interval &o_int, uint64_t o_value) {
        std::pair<uint64_t, uint64_t> q;
    ...
    template <> //NO Select in BWT
    uint64_t ring_knn_naive<bwt<>>::min_S_in_O(bwt_interval &o_int, uint64_t o_value) {
    ...
    template <> //NO Select in BWT
    uint64_t ring_knn_naive<bwt_rrr>::min_S_in_O(bwt_interval &o_int, uint64_t o_value) {
        uint64_t o_aux = o_int.left();
        std::pair<uint64_t, uint64_t> p_r = m_bwt_p.inverse_select(o_aux);
        uint64_t s = m_bwt_s[m_bwt_s.get_C(p_r.second/*s_value*/) + p_r.first/*r*/];
        o_int.set_stored_values(s, 0);
    ...
    template <class bwt_so_t, class bwt_sp_t> //Select in BWT
    uint64_t ring_knn_naive<bwt_so_t, bwt_sp_t>::next_S_in_O(bwt_interval &I, uint64_t o_value, uint64_t s_value) {
        if (s_value > m_max_s) return 0;
    ...
    template <> //NO Select in BWT
    uint64_t ring_knn_naive<bwt<>>::next_S_in_O(bwt_interval &I, uint64_t o_value, uint64_t s_value) {
        if (s_value > m_max_s) return 0;
    ...
    template <> //NO Select in BWT
    uint64_t ring_knn_naive<bwt_rrr>::next_S_in_O(bwt_interval &I, uint64_t o_value, uint64_t s_value) {
        if (s_value > m_max_s) return 0;
    ...
    typedef ring_knn_naive<bwt_rrr, bwt_rrr> c_ring_knn_naive;
    typedef ring_knn_naive<bwt_plain, bwt_plain> ring_knn_naive_sel; //with select
